...
image_path = 'local da imagem'


known_face_path = 'local da imagem do rosto conhecido'

unknown_image_path = 'local da imagem do rosto desconhecido'
...
identify_face(unknown_image_path, know_face_encodings, know_face_names)